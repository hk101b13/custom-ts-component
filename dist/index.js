...
var lt;
function pt() {
  return lt || (lt = 1, process.env.NODE_ENV === "production" ? hr.exports = Ut() : hr.exports = Vt()), hr.exports;
}
/**
 * @license React
...
function Bt() {
  ...
  return Ke.Fragment = Re, Ke.jsx = te, Ke.jsxs = te, Ke;
}
process.env.NODE_ENV === "production" ? Mr.exports = Bt() : Mr.exports = Yt();
var se = Mr.exports;
function zt(V) {
